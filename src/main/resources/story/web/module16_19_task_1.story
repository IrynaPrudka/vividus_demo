...
When I click on element located by `By.xpath(//li[contains(@id,"General Information Request")])`

When I enter `Iryna` in field located by `By.xpath(//input[@name='user_first_name'])`
When I enter `Prudka` in field located by `By.xpath(//input[@name='user_last_name'])`
When I enter `iryna_prudka@epam.com` in field located by `By.xpath(//input[@name='user_email'])`
When I enter `+38(050)5199069` in field located by `By.xpath(//input[@name='user_phone'])`

When I click on element located by `By.xpath(//span[contains(@aria-labelledby,"user_country")])`
When I click on element located by `By.xpath(//li[contains(@id,"Ukraine")])`

When I click on element located by `By.xpath(//span[contains(@aria-labelledby,"user_comment_how_hear_about")])`
When I click on element located by `By.xpath(//li[contains(@id,"Worked at EPAM")])`
